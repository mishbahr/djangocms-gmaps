...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Map.plugin_template'
        db.add_column(u'djangocms_gmaps_map', 'plugin_template',
                      self.gf('django.db.models.fields.CharField')(default=settings.DJANGOCMS_GMAPS_TEMPLATES[0][0], max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Map.plugin_template'
        db.delete_column(u'djangocms_gmaps_map', 'plugin_template')
    ...
    models = {
        ...
        u'djangocms_gmaps.location': {
            ...
            'marker_icon': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'djangocms_map_marker_icons'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['filer.Image']"}),
            'photo': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'djangocms_map_locations'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['filer.Image']"}),
        ...
        u'djangocms_gmaps.map': {
            ...
            'plugin_template': ('django.db.models.fields.CharField', [], {'default': "'djangocms_gmaps/default.html'", 'max_length': '255'}),

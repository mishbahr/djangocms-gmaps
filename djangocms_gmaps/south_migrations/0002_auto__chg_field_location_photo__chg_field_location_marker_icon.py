...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Location.photo'
        db.alter_column(u'djangocms_gmaps_location', 'photo_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['filer.Image']))

        # Changing field 'Location.marker_icon'
        db.alter_column(u'djangocms_gmaps_location', 'marker_icon_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['filer.Image']))
